...
async function _kachelTurnierCheck(){
  ...
  slot.innerHTML=kSec("🏆 Turnier steht an")
    +kTiles([
      (heimAngelegt||(terminTurnier&&terminTurnier.heim))?{emo:"🏟️",label:"Festival ausrichten",fn:"htOpen"}:null,
