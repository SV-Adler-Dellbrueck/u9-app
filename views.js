...
const HELP=[
  ...
  {cat:"🏃 Training", items:[
    {t:"Anwesenheit erfassen", d:"Wer war da – Haken je Kind. Die Trainer-Haken zeigen bis zum Tag die Rückmeldungen aus „Bist du dabei?“ – ein Tap darauf ändert die Rückmeldung des Kollegen für alle. Am Tag selbst werden die Haken mit „Speichern“ zur Anwesenheit dieses Tages. Ist der gewählte Termin ein Spiel, Turnier oder Event, steht unter dem Termin eine Karte mit dem passenden Werkzeug: Heimturnier planen, Spieltag, Mitbringliste – ein Trainingsplan wird dann nicht gebraucht. Die Saison-Auswertung dazu liegt bei Team.", go:"anwesenheit"},
