...
const HELP=[
  ...
  {cat:"⚽ Spieltag", items:[
    ...
    {t:"Festival ausrichten", d:"Für das Kinderfestival bei uns: Du trägst die Gastvereine mit ihren angereisten Kindern ein, die App macht daraus Teams (10 Kinder = zwei Teams) und schlägt die Felder vor – Standard ein 4+1-Feld mit Jugendtoren und zwei FUNiño-Felder mit Minitoren, änderbar. Aus Beginn, Gesamtdauer und Spielzeit entsteht ein Runden-Plan: pro Runde spielen alle Felder gleichzeitig, jede Mannschaft trifft möglichst jede andere und wechselt dabei zwischen den Formaten. Keine Tabelle – bei uns gewinnt die Freude am Spiel. Den fertigen Plan schickst du als Link an die Gast-Trainer (mit Wappen, Feldern und Zeiten, ohne Login) oder druckst ihn als Aushang. Am Spieltag führt die Turnier-Kachel im Spieltag hierher, wenn wir ausrichten; sind wir zu Gast, öffnet sie den Turnier-Modus zum Erfassen der Kurzspiele.", run:"htOpen()"},
  ]},
  {cat:"🎯 Taktik", items:[
