...
(function adlerIntro(){
  try{
    ...
    st.textContent=
      ...
      "#adler-intro.ai-adler img{animation:adlerIntroFlugAdler 1.35s cubic-bezier(.3,.7,.35,1) both}#adler-intro.ai-adler .ai-flug{animation:adlerIntroAtem 1.3s ease-in-out 1.4s}"+
      ...
      "@media (prefers-reduced-motion: reduce){#adler-intro{animation-delay:.6s}"+
        "#adler-intro img,#adler-intro .ai-name{animation:none!important;opacity:1}#adler-intro .ai-flug,#adler-intro .ai-ring:before,#adler-intro .ai-glanz,#adler-intro .ai-glanz:after{animation:none!important}#adler-intro .ai-feder{display:none}}";
    ...
    d.innerHTML=federn+'<div class="ai-ring"><div class="ai-flug"><img src="logo.png" alt="" onerror="this.style.visibility=\'hidden\'"></div>'+(art==="muenze"?'<div class="ai-glanz"></div>':'')+'</div>'+
